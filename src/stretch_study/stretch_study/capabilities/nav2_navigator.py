...
class Nav2Navigator:
    """BasicNavigator wrapper that loads named goals from YAML and supports stand-off distance."""
    ...
    def goto(self, name: str, timeout_s: float = 120.0, feedback_every_s: float = 2.0, stand_off_m: float = 0.0) -> bool:
